...
public class JwtTokenProvider {
    ...
    public String createToken(String username, Set<Role> useRoles) {

        Claims claims = Jwts.claims().setSubject(username);
        claims.put("auth", useRoles.stream().map(s -> new SimpleGrantedAuthority(s.getAuthority())).filter(Objects::nonNull).collect(Collectors.toList()));
